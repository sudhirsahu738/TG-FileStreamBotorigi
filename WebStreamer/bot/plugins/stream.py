...
async def private_receive_handler(c: Client, m: Message):
    try:
        ...
        reply_markup, Stream_Text,file_name = await gen_link(m=m, log_msg=log_msg, from_channel=False) , stream_link = await gen_link(m=m, log_msg=log_msg, from_channel=False)
