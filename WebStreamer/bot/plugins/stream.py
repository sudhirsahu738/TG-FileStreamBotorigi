...
async def private_receive_handler(c: Client, m: Message):
    try:
        ...
        await log_msg.reply_text(text=f"**ꜰɪʟᴇ ɴᴀᴍᴇ:** {file_name} \n**RᴇQᴜᴇꜱᴛᴇᴅ ʙʏ :** [{m.from_user.first_name}](tg://user?id={m.from_user.id})\n**Uꜱᴇʀ ɪᴅ :** `{m.from_user.id}`\n**Dᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ :** {stream_link}\** ꜱᴛʀᴇᴀᴍɪɴɢ ʟɪɴᴋ:** {page_link}", disable_web_page_preview=True, parse_mode=ParseMode.MARKDOWN, quote=True)
